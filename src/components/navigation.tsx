...
export function Navigation() {
  return (
    ...
    >
      ...
      >
        <Link href="/" className="text-lg md:text-2xl font-bold tracking-tighter text-primary">
          EVA ALONSO
        </Link>
      </motion.div>
      ...
      <NavigationMenu>
        <NavigationMenuList className="hidden lg:flex gap-4 xl:gap-8">
          <NavigationMenuItem>
            <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
              <NavigationMenuLink asChild>
                <Link href="/social-media" className="text-xs xl:text-sm font-medium tracking-wider text-primary hover:text-[oklch(0.85_0.15_88)] transition-colors">
          ...
          <NavigationMenuItem>
            <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
              <NavigationMenuLink asChild>
                <Link href="/content" className="text-xs xl:text-sm font-medium tracking-wider text-primary hover:text-[oklch(0.85_0.15_88)] transition-colors">
          ...
          <NavigationMenuItem>
            <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
              <NavigationMenuLink asChild>
                <Link href="/portfolio" className="text-xs xl:text-sm font-medium tracking-wider text-primary hover:text-[oklch(0.85_0.15_88)] transition-colors">
                  PORTFOLIO
                </Link>
              </NavigationMenuLink>
            </motion.div>
          ...
          <NavigationMenuItem>
            <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
              <NavigationMenuLink asChild>
                <Link href="/about" className="text-xs xl:text-sm font-medium tracking-wider text-primary hover:text-[oklch(0.85_0.15_88)] transition-colors">
                  ABOUT
                </Link>
              </NavigationMenuLink>
            </motion.div>
      ...
      <div className="flex gap-2 md:gap-4 items-center">
        <motion.div whileHover={{ scale: 1.2, rotate: 5 }} transition={{ duration: 0.2 }}>
          <Link
            ...
            className="h-4 w-4 md:h-5 md:w-5 text-primary hover:text-[oklch(0.65_0.12_200)] transition-colors"
          >
